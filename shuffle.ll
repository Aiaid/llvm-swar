...
@vec1 = constant <16 x i8> <i8 123, i8 12, i8 33, i8 35, i8 123, i8 12, i8 33, i8 35, i8 123, i8 12, i8 33, i8 35, i8 123, i8 12, i8 33, i8 35> ; 001 010 011 011
@vec2 = constant <16 x i8> <i8 2, i8 7, i8 2, i8 4, i8 2, i8 7, i8 2, i8 4, i8 2, i8 7, i8 2, i8 4, i8 2, i8 7, i8 2, i8 4> ; 101 001 001 011
...
define i16 @main() {
 ...
 %1 = shufflevector <16 x i8> %v1, <16 x i8> %v2, <4 x i32> <i32 0, i32 4, i32 1, i32 5>
...
;  %17 = extractelement <16 x i8> %1, i32 15
 ...
 %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8 %2, i8 %3, i8 %4, i8 %5)
 ret i16 0
}