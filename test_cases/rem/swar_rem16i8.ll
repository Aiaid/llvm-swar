; ModuleID = '../test_cases/rem/rem16i8.ll'
source_filename = "../test_cases/rem/rem16i8.ll"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %149 = trunc <16 x i16> %145 to <16 x i8>
  %150 = bitcast <16 x i8> %149 to <16 x i8>
  %151 = extractelement <16 x i8> %150, i32 1
  %152 = extractelement <16 x i8> %150, i32 2
  %153 = extractelement <16 x i8> %150, i32 3
  %154 = extractelement <16 x i8> %150, i32 4
  %155 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i8 %151, i8 %152, i8 %153, i8 %154)
  ret i32 0
}
