; ModuleID = '../test_cases/add/add5i5.ll'
source_filename = "../test_cases/add/add5i5.ll"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %47 = bitcast <5 x i5> %45 to i25
  %48 = and i25 %46, 16236015
  %49 = and i25 %47, 16236015
  %50 = add i25 %48, %49
  %51 = xor i25 %46, %47
  %52 = and i25 %51, -16236016
  %53 = xor i25 %50, %52
  %54 = bitcast i25 %53 to <5 x i5>
  %55 = extractelement <5 x i5> %54, i32 1
  %56 = extractelement <5 x i5> %54, i32 2
  %57 = extractelement <5 x i5> %54, i32 3
  %58 = extractelement <5 x i5> %54, i32 4
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), i5 %55, i5 %56, i5 %57, i5 %58)
  ret i32 0
}
