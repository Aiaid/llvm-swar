; ModuleID = '../test_cases/add/add32i4.ll'
source_filename = "../test_cases/add/add32i4.ll"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %44 = bitcast <32 x i4> %42 to i128
  %45 = bitcast <32 x i4> %43 to i128
  %46 = and i128 %44, 158798437896437949616241483468158498679
  %47 = and i128 %45, 158798437896437949616241483468158498679
  %48 = add i128 %46, %47
  %49 = xor i128 %44, %45
  %50 = and i128 %49, -158798437896437949616241483468158498680
  %51 = xor i128 %48, %50
  %52 = bitcast i128 %51 to <32 x i4>
  %53 = extractelement <32 x i4> %52, i32 1
  %54 = extractelement <32 x i4> %52, i32 2
  %55 = extractelement <32 x i4> %52, i32 3
  %56 = extractelement <32 x i4> %52, i32 4
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i4 %53, i4 %54, i4 %55, i4 %56)
  ret i32 0
}
