; ModuleID = '../test_cases/add/add64i2.ll'
source_filename = "../test_cases/add/add64i2.ll"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %44 = bitcast <64 x i2> %42 to i128
  %45 = bitcast <64 x i2> %43 to i128
  %46 = and i128 %44, 113427455640312821154458202477256070485
  %47 = and i128 %45, 113427455640312821154458202477256070485
  %48 = add i128 %46, %47
  %49 = xor i128 %44, %45
  %50 = and i128 %49, -113427455640312821154458202477256070486
  %51 = xor i128 %48, %50
  %52 = bitcast i128 %51 to <64 x i2>
  %53 = extractelement <64 x i2> %52, i32 1
  %54 = extractelement <64 x i2> %52, i32 2
  %55 = extractelement <64 x i2> %52, i32 3
  %56 = extractelement <64 x i2> %52, i32 4
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i2 %53, i2 %54, i2 %55, i2 %56)
  ret i32 0
}
