; ModuleID = '../test_cases/div/div32i4.ll'
source_filename = "../test_cases/div/div32i4.ll"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %96 = or <32 x i4> %95, %83
  %97 = bitcast <32 x i4> %96 to <32 x i4>
  %98 = extractelement <32 x i4> %97, i32 1
  %99 = extractelement <32 x i4> %97, i32 2
  %100 = extractelement <32 x i4> %97, i32 3
  %101 = extractelement <32 x i4> %97, i32 4
  %102 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i4 %98, i4 %99, i4 %100, i4 %101)
  ret i32 0
}
