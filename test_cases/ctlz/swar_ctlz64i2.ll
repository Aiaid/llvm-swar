; ModuleID = '../test_cases/ctlz/ctlz64i2.ll'
source_filename = "../test_cases/ctlz/ctlz64i2.ll"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %44 = lshr <64 x i2> %42, <i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1, i2 1>
  %45 = or <64 x i2> %42, %44
  %46 = lshr <64 x i2> %45, zeroinitializer
  %47 = or <64 x i2> %45, %46
  %48 = xor <64 x i2> %47, <i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1, i2 -1>
  %49 = bitcast <64 x i2> %48 to i128
  %50 = and i128 %49, 113427455640312821154458202477256070485
  %51 = lshr i128 %49, 1
  %52 = and i128 %51, 113427455640312821154458202477256070485
  %53 = add i128 %50, %52
  %54 = bitcast i128 %53 to <64 x i2>
  %55 = extractelement <64 x i2> %54, i32 1
  %56 = extractelement <64 x i2> %54, i32 2
  %57 = extractelement <64 x i2> %54, i32 3
  %58 = extractelement <64 x i2> %54, i32 4
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i2 %55, i2 %56, i2 %57, i2 %58)
  ret i32 0
}
...
declare <64 x i2> @llvm.ctlz.v64i2(<64 x i2>, i1 immarg) #2
