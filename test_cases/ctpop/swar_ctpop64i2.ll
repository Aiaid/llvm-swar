; ModuleID = '../test_cases/ctpop/ctpop64i2.ll'
source_filename = "../test_cases/ctpop/ctpop64i2.ll"
...
declare <64 x i2> @llvm.ctpop.v64i2(<64 x i2>) #0
...
define dso_local i32 @main(i32 %0, i8** %1) #1 {
  ...
  %48 = add i128 %45, %47
  %49 = bitcast i128 %48 to <64 x i2>
  %50 = extractelement <64 x i2> %49, i32 1
  %51 = extractelement <64 x i2> %49, i32 2
  %52 = extractelement <64 x i2> %49, i32 3
  %53 = extractelement <64 x i2> %49, i32 4
  %54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i2 %50, i2 %51, i2 %52, i2 %53)
  ret i32 0
}
