; ModuleID = '../test_cases/ctpop/ctpop32i4.ll'
source_filename = "../test_cases/ctpop/ctpop32i4.ll"
...
declare <32 x i4> @llvm.ctpop.v32i4(<32 x i4>) #0
...
define dso_local i32 @main(i32 %0, i8** %1) #1 {
  ...
  %52 = add i128 %49, %51
  %53 = bitcast i128 %52 to <32 x i4>
  %54 = extractelement <32 x i4> %53, i32 1
  %55 = extractelement <32 x i4> %53, i32 2
  %56 = extractelement <32 x i4> %53, i32 3
  %57 = extractelement <32 x i4> %53, i32 4
  %58 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i32 0, i32 0), i4 %54, i4 %55, i4 %56, i4 %57)
  ret i32 0
}
